...
# !!! Main.UserApp is configured as an alias for Main.DockerTest and you might encounter it in some tests
using Main.DockerTest, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "DockerTest tests" begin
  @includetests ARGS
end
